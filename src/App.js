...
/**
 * Main component that holds all other components. 
 * Also has state for:
 * user uploaded svg file,
 * gcode file generated by back end,
 * download link for the gcode,
 * options
 * These are passed to child components as needed.
...
/**
 * Generates new gcode file from file and options
 *
 * @param {*} options user set options
